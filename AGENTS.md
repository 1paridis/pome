...
- Treat an existing `.pome/nursery/<需求简称>/test-case.md` as protected history. An `orchard.md` in the same directory may be read as input but must not be modified by trial.
